/* 
    ...
    Solução de: Davi Alves Carvalho
*/

#include <iostream>
#include <algorithm> // para utilizar o copy
using namespace std;
...
armazem::armazem(const armazem &copia)
{
...
{
    item *listaAux = new item[quantidadeDeItens];
    copy(listaDeItens, listaDeItens + quantidadeDeItens, listaAux);
    delete[] listaDeItens;
    capacidadeMaxima += 3;
    listaDeItens = new item[capacidadeMaxima];
    copy(listaAux, listaAux + quantidadeDeItens, listaDeItens);
    delete[] listaAux;
	// cout << "Redimensionando aumentando 3 posicoes ... " << endl;
}
